...
List<PlanetDetail> planetdetails = [
  PlanetDetail(
      ...
      Discovered in 2016 using the radial velocity method, it is particularly intriguing due to its proximity and potential for habitability.
      Proxima Centauri b orbits its star at a distance of about 0.05 AU, similar to Mercury's distance from the Sun, 
      ...
      possibly featuring a solid surface. Situated in the habitable zone of its star, Proxima Centauri b could theoretically support liquid water depending on its atmospheric conditions. 
      However, Proxima Centauri is a red dwarf, much cooler and dimmer than the Sun, and is known for flaring, which could expose orbiting planets to intense radiation.
      The planet may be tidally locked, leading to stark temperature differences between its day and night sides. 
      While it remains uncertain whether Proxima Centauri b has an atmosphere, future studies with advanced telescopes like the James Webb Space Telescope may provide insights into its atmospheric composition, which is critical for assessing its habitability.
  ...
  PlanetDetail(
      ...
      Discovered by the Kepler Space Telescope in 2015, it orbits a G-type star similar to our Sun, known as Kepler-452. 
      The planet has a radius about 1.6 times that of Earth and is classified as a super-Earth due to its larger size and mass.
      Kepler-452b orbits its star in the habitable zone, where conditions may allow for liquid water to exist, making it a candidate for potential habitability. 
      Its orbital period is about 385 days, which is similar to Earth's year. 
  ...
  PlanetDetail(
      ...
      With a mass approximately 0.46 times that of Jupiter and a radius 1.2 times larger due to atmospheric expansion, 51 Pegasi b has extreme surface temperatures of around 1,200°C (2,192°F), making it inhospitable for life. 
      Likely tidally locked, the planet has one side perpetually facing its star.
